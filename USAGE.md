...
```text
①  주소를 붙여넣고  [ 살펴보기 ]
②  페이지에 있는 것들이 예시와 함께 나옵니다
    → 모으고 싶은 것에 이름을 붙이고  [ 모으기 ]
③  표가 나오면  [ 엑셀로 저장 ]
```
